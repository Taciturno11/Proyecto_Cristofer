        ...
        >
          ...
          <div class="p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              @for (item of (order.orderItemList || order.orderItems || []);
              track item.id) {
              <div
                class="border border-gray-200 rounded-lg p-3 hover:border-[#a81b8d] transition"
              >
                ...
                <div
                  class="w-full h-32 bg-gray-200 rounded-lg flex items-center justify-center mb-2"
                >
                  <span class="text-4xl">📦</span>
                </div>
                }
                <p class="font-medium text-gray-900 text-sm line-clamp-2 mb-1">
                  {{ item.product.name }}
                </p>
                <div
                ...
                >
                  ...
                  <span class="font-bold text-[#a81b8d]"
                    >S/
                    {{
                      (
                        (item.itemPrice || item.price || 0) * item.quantity
                      ).toFixed(2)
                    }}</span
                  >
                </div>
