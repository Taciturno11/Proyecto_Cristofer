...
export class OrderService {
  ...
  getUserProfile(): Observable<any> {
    return this.http.get<any>(
      `${API_ENDPOINTS.BASE_URL}/user/profile`
    ).pipe(
      catchError(this.handleError)
    );
  }
  ...
  getAllOrders(): Observable<Order[]> {
    return this.http.get<Order[]>(
      `${API_ENDPOINTS.BASE_URL}${API_ENDPOINTS.ADMIN.ORDERS_ALL || '/admin/orders'}`
    ).pipe(
      catchError(this.handleError)
    );
  }
  ...
  updateOrderStatus(orderId: string, newStatus: OrderStatus): Observable<Order> {
    return this.http.put<Order>(
      `${API_ENDPOINTS.BASE_URL}/admin/orders/${orderId}/status`,
      { status: newStatus }
    ).pipe(
      catchError(this.handleError)
    );
  ...
  getOrdersByStatus(status: OrderStatus): Observable<Order[]> {
    ...
    return this.http.get<Order[]>(
      `${API_ENDPOINTS.BASE_URL}/admin/orders`,
      { params }
    ).pipe(
      catchError(this.handleError)
    );
  ...
  getOrderStatistics(): Observable<any> {
    return this.http.get<any>(
      `${API_ENDPOINTS.BASE_URL}/admin/orders/statistics`
    ).pipe(
      catchError(this.handleError)
    );
  }
   ...
   */
  assignDeliveryPerson(orderId: string, deliveryPersonId: string): Observable<Order> {
    return this.http.put<Order>(
