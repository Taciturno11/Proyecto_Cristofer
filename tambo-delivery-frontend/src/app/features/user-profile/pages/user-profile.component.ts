      ...
      @if (loading) {
        ...
        <div class="space-y-6">
          ...
          <div class="bg-white rounded-lg shadow-md p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">Estado de cuenta</h3>
              ...
              <div class="bg-purple-50 rounded-lg p-4">
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    <p class="text-2xl font-bold text-purple-600">S/ {{ stats.totalSpent.toFixed(2) }}</p>
                  </div>
        ...
        <div class="text-center py-12">
          ...
          <h3 class="text-lg font-medium text-gray-900 mb-2">No se pudo cargar el perfil</h3>
  ...
  loadUserStats(): void {
    ...
    this.orderService.getUserOrders().subscribe({
      next: (orders) => {
        ...
        this.stats.deliveredOrders = orders.filter(o => o.orderStatus === 'DELIVERED').length;
        this.stats.totalSpent = orders.reduce((sum, o) => sum + (o.totalAmount || 0), 0);
