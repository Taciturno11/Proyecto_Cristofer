          ...
          <div>
            <div class="flex items-center justify-between mb-4">
              <h2 class="text-xl font-semibold text-gray-900">
                @if (savedAddresses.length > 0) { Agregar nueva dirección }
                @else { Información de entrega }
              </h2>
              @if (savedAddresses.length > 0) {
              <button
              ...
              >
                @if (showNewAddressForm) { Cancelar } @else { + Agregar nueva }
              </button>
              }
            </div>
            ...
            <form [formGroup]="addressForm" class="space-y-4">
              ...
              <div>
                ...
                />
                @if (addressForm.get('name')?.touched &&
              ...
              <div>
                ...
                <input
                  ...
                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#a81b8d] focus:border-transparent"
                />
                @if (addressForm.get('address')?.touched &&
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  addressForm.get('phone')?.errors?.['required']) {
                  <p class="mt-1 text-sm text-red-600">
                    Este campo es requerido
                  </p>
                  }
...
export class DeliveryAddressComponent {
  ...
  selectedAddressId: number | null =
    this.savedAddresses.find((addr) => addr.isDefault)?.id || null;
  ...
  proceedToPayment(): void {
    ...
    if (this.showNewAddressForm && this.addressForm.valid) {
      ...
      const saved = this.savedAddresses.find(
