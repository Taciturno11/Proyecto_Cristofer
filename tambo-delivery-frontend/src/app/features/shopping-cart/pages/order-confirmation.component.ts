        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div class="space-y-4">
              ...
              <div
                class="flex items-center space-x-4 pb-4 border-b border-gray-100 last:border-b-0 last:pb-0"
              >
                @if (item.image) {
                <img
                  [src]="item.image"
                ...
                />
                <div
                  class="h-16 w-16 bg-gray-200 rounded-md border items-center justify-center text-xl flex-shrink-0 hidden"
                >
                  📦
                </div>
                } @else {
                <div
                  class="h-16 w-16 bg-gray-200 rounded-md border flex items-center justify-center text-xl flex-shrink-0"
                >
                  📦
                </div>
                }
                <div class="flex-1">
                  ...
                  <p class="text-sm font-medium text-[#a81b8d]">
          ...
          <div class="bg-white rounded-lg border border-gray-200 p-6">
            <div class="flex items-center justify-between mb-4">
              ...
              <button
                (click)="goToAddress()"
                class="text-sm text-[#a81b8d] hover:underline"
              >
                Cambiar
              </button>
            </div>
              ...
              <div>
                ...
                <div class="text-sm text-gray-900">
                  ...
                  <p class="text-gray-600 mt-1">
                    Ref: Casa blanca con reja negra
                  </p>
                </div>
              </div>
          ...
          <div class="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div class="flex items-center space-x-3">
              <img
                src="assets/icons/logo-yape.webp"
                alt="Yape"
                class="h-8 w-auto"
              />
              <div>
            ...
            <div class="flex items-start space-x-3">
              ...
              <div class="text-sm">
                ...
                <ul class="text-yellow-800 space-y-1">
                  ...
                  <li>
                    • Asegúrate de que la dirección de entrega sea la correcta
                  </li>
                  <li>• Ten tu celular listo para el pago con Yape</li>
                  <li>
                    • Nuestro repartidor se comunicará contigo antes de llegar
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div class="lg:col-span-1">
          <div class="bg-gray-50 rounded-lg p-6 sticky top-32">
            ...
            >
              <div class="text-center">
                ...
                <p class="text-xs text-green-700">
                  Tu pedido llegará en 30-45 min
                </p>
              </div>
            </div>
            ...
            <p class="text-xs text-gray-500 text-center">
              ...
              <a href="/terminos" class="text-[#a81b8d] hover:underline"
                >términos y condiciones</a
              >
              y
              <a href="/politicas" class="text-[#a81b8d] hover:underline"
      ...
      <div class="mt-8 flex justify-between">
        ...
        <div class="flex items-center space-x-4">
          <span class="text-sm text-gray-600"
            >Total: S/ {{ getTotal().toFixed(2) }}</span
          >
          <app-button
            [config]="{
...
export class OrderConfirmationComponent implements OnInit {
    ...
    this.orderService.createOrder(orderRequest).subscribe({
      ...
      error: (error) => {
        ...
        if (
          ...
          console.warn(
            'Modo demo: Navegando al tracking sin crear pedido en backend'
          );
  ...
  prepareOrderRequest(): OrderRequest {
    ...
    const paymentMethodData =
      localStorage.getItem('selectedPaymentMethod') || 'YAPE';
    const locationData = localStorage.getItem('deliveryLocation');
    const cartData = localStorage.getItem('cart');
    ...
    const paymentMethod =
      paymentMethodMap[paymentMethodData] || PaymentMethod.DIGITAL_WALLET;
