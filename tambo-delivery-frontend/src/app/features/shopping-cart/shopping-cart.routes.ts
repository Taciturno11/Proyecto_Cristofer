...
export const CART_ROUTES: Routes = [
  ...
  {
    path: 'ubicacion',
    loadComponent: () => import('./pages/store-location.component').then(c => c.StoreLocationComponent),
  ...
  {
    path: 'seguimiento',
    loadComponent: () => import('./pages/order-tracking.component').then(c => c.OrderTrackingComponent),
    canActivate: [AuthGuard] // Requiere autenticación
  }
];
