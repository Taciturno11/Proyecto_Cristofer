    ...
    <footer class="bg-gray-100 text-gray-500 mt-auto">
      <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <!-- Enlaces rápidos -->
          <div>
            <h4 class="text-lg font-bold text-[#a81b8d] mb-4">MI CUENTA</h4>
            <ul class="space-y-2">
              <li>
                <a
                  routerLink="#"
                  class="text-sm hover:text-gray-950 transition-colors efecto"
                  >Pedir</a
                >
              </li>
              <li>
            ...
            <div class="flex space-x-4">
              <p class="text-lg text-[#a81b8d] font-bold">SÍGUEME EN</p>
              <!-- Facebook -->
              <a
                href="https://www.facebook.com/PractitiendasTambo"
                target="_blank"
                class="hover:text-gray-950 transition-colors efecto"
                aria-label="Facebook"
              >
              ...
              <!-- Instagram -->
              <a
                href="https://www.instagram.com/tiendas_tambo/"
                target="_blank"
                class="hover:text-gray-950 transition-colors efecto"
              ...
              <!-- TikTok -->
              <a
                href="https://www.tiktok.com/@tiendas_tambo"
                target="_blank"
                class="hover:text-gray-950 transition-colors efecto"
                aria-label="TikTok"
              >
          ...
          <!-- Servicio al cliente -->
          <div>
            <h4 class="text-lg font-bold text-[#a81b8d] mb-4">CONÓCENOS</h4>
            <ul class="space-y-2">
              <li>
                <a
                  routerLink="#"
              ...
              <li>
                <a
                  href="http://consultafe.lindcorp.pe/Public/20563529378/search"
                  target="_blank"
                  class="text-sm hover:text-gray-950 transition-colors"
          ...
          <div>
            <h4 class="text-lg font-bold text-[#a81b8d] mb-4">
              SERVICIO AL CLIENTE
            </h4>
            <ul class="space-y-2">
              <li>
